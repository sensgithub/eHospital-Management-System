    ...
    <div class="menu">
        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                    ...
                    <td>
                        <p style="font-size: 23px;font-weight: 600; padding-left: 50px">Настройки</p>
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        <div>
                                                ...
                                                <div class="h3-dashboard"  style="font-size: 15px;">
                                                    Персонална информация за вашия акаунт
                                                </div>
                                        </div>
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        <div>
                                                ...
                                                <div class="h3-dashboard"  style="font-size: 15px;">
                                                   Перманентно изтриване на вашия акаунт
                                                </div>
                                        </div>
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            Искате да изтриете вашия акаунт<br>('.substr($nameget,0,40).')?
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">         
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Дата на раждане: </label>
            ...
            $error_1=$_GET["error"];
                $errorlist= array(
                    '1'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Вече има регистритан потребител с този е-майл.</label>',
                    '2'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Паролите не съвпадат! Моля, въведете вашата парола наново.</label>',
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500; padding-bottom:10px">Редактиране на детайли на потребител.</p>
                                        ID на потребител : '.$id.' <br> (генерирано автоматично)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="password" class="input-text" placeholder="Задаване на парола" required><br>
                                        </td>
                                    </tr><tr>
                                        <td class="label-td" colspan="2">
                                            <label for="cpassword" class="form-label">Потвъждаване на парола: </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="cpassword" class="input-text" placeholder="Потвъждаване на парола" required><br>
                                        </td>
                                    </tr>
            ...
            echo '
                <div id="popup1" class="overlay">
                        ...
                        <center>
                        <br><br><br><br>
                            <h2>Вашите промени са успешно запазени!</h2>
                            <a class="close" href="settings.php">&times;</a>
                            <div class="content">
                                Ако желаете да промените вашия е-майл, моля излезте и влезте с вашия нов е-майл!                             
                            </div>
                            <div style="display: flex;justify-content: center;">
